...
function emailCustomerOrder_(b){
  ...
  +'<tr><td style="padding:22px 36px 26px;font-size:13px;color:#7C736E;line-height:1.6">Track this order anytime at <a href="'+SITE_URL+'/status.html?order='+o.id+'" style="color:#B4432C">'+SITE_URL.replace("https://","")+'/status</a>. Reply to this email with any question about the order. All sales are final once shipped; damaged or incorrect items are replaced when reported within 7 days with photos.</td></tr>';
...
function emailCustomerShipped_(o){
  var body='<tr><td style="padding:10px 36px 6px"><h1 style="font-family:Georgia,serif;font-weight:normal;font-size:30px;margin:0 0 12px">Order '+o.order_id+' has shipped.</h1><p style="font-size:15px;line-height:1.6;color:#4F4744;margin:0 0 18px">Tracking number: <b>'+o.tracking+'</b><br>Shipping method: '+o.shipping+'<br>Plain outer packaging with a cold pack. Store at −20 °C on receipt.</p>'+btn_(SITE_URL+"/status.html?order="+o.order_id,"View order status")+'</td></tr>';
