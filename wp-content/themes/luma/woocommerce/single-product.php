<?php
/**
 * Product page — port of legacy product.html + js/product.js. The product is
 * identified by slug; everything renders client-side from LUMA_PRODUCTS so the
 * page matches the original exactly. Add-to-cart goes to WooCommerce.
 */
global $post;
...
get_header();
?>
<main id="main" data-product="<?php echo esc_attr( $slug ); ?>">
<div class="wrap">
 <div class="breadcrumb" style="padding-top:2rem"><a href="<?php echo esc_url( $u['home'] ); ?>">Home</a> › <a href="<?php echo esc_url( $u['shop'] ); ?>">Catalog</a> › <span id="crumbName"></span></div>
 <div class="pdp">
  <div class="pdp-gallery" id="gallery"></div>
  <div class="pdp-info" id="info"></div>
 </div>
 <section class="related">
  <div class="section-title"><h2>Related compounds</h2></div>
...
document.addEventListener("DOMContentLoaded",()=>{
  ...
  const id=document.getElementById("main").dataset.product;
