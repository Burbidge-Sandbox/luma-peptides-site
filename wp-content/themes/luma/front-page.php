...
document.addEventListener("DOMContentLoaded",()=>{
 ...
 (function(){ const C=window.LUMA_CONFIG, P=C.promises||{}; const tiles=[
   ...
   {k:"Free delivery",t:P.nextDay?"Free next-day shipping, always":"Free US shipping",d:P.sameDay?`No minimum, no code. ${P.sameDayPromise} <a class="sd-link" href="${C.urls.shipping||"/shipping-returns/"}#same-day">Check your ZIP →</a>`:"On every US order. No minimum, no code."},
