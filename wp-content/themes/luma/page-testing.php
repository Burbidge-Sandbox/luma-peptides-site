 ...
 * The browsable certificate library ([luma_coa_library]) is intentionally not
 * rendered until the lot count justifies it; lookup is by lot number only.
 */
get_header();
?>
<main id="main">
...
<div class="wrap" style="padding-bottom:5rem">
 ...
 <div class="values" style="max-width:960px;margin:4rem auto 0">
  <div class="value"><svg viewBox="0 0 24 24"><path d="M9 3h6v5l4 9a3 3 0 0 1-3 4H8a3 3 0 0 1-3-4l4-9z"/><path d="M8 14h8"/></svg><h3>What we test</h3><p>Purity by RP-HPLC, identity by LC-MS, and net content by weight. All three must pass before a lot is released.</p></div>
