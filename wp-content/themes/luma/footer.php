...
<footer class="footer"><div class="wrap">
 <div class="footer-grid">
  ...
  <div><h4>Support</h4><ul><li><a href="<?php echo esc_url( $u['faq'] ); ?>">FAQ</a></li><li><a href="<?php echo esc_url( $u['track'] ); ?>">Track order</a></li><li><a href="<?php echo esc_url( $u['account'] ); ?>">Account</a></li><li><a href="<?php echo esc_url( $u['shipping'] ); ?>">Shipping</a></li><li><a href="<?php echo esc_url( $u['shipping'] . '#returns' ); ?>">Returns</a></li><li><a href="<?php echo esc_url( $u['privacy'] ); ?>">Privacy Policy</a></li><li><a href="<?php echo esc_url( $u['terms'] ); ?>">Terms</a></li></ul></div>
