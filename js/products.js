...
window.LUMA_PRODUCTS = [
  {
    id:"tirzepatide-15", name:"Tirzepatide", label:["TIRZEPATIDE","15MG"], strength:"15mg vial",
  ...
  {
    id:"wolverine-stack", name:"Wolverine Stack", label:["WOLVERINE","STACK"], strength:"5mg blend",
  ...
  {
    id:"cjc-ipamorelin", name:"CJC-1295 + Ipamorelin", label:["CJC-1295 +","IPAMORELIN"], strength:"5mg blend",
  ...
  {
    id:"ghk-cu", name:"GHK-Cu", label:["GHK-CU","5MG"], strength:"5mg vial",
  ...
  {
    id:"glow-klow", name:"Glow + Klow", label:["GLOW + KLOW","5MG"], strength:"5mg blend",
  ...
  {
    id:"bpc-157", name:"BPC-157", label:["BPC-157","5MG"], strength:"5mg vial",
    ...
    inside:"BPC-157 5mg, lyophilized. Ships with bacteriostatic water and supplies.",
    specs:{"Form":"Lyophilized powder","Vial size":"3ml, 5mg","Purity (last lot)":"99.5%","Storage":"Refrigerate after reconstitution","Supply":"4-week protocol"},
    faqs:[["Oral or injectable?","We ship injectable. Injection near the site of concern is the most-studied route."]]
  },
  {
    id:"semaglutide-10", name:"Semaglutide", label:["SEMAGLUTIDE","10MG"], strength:"10mg vial",
  ...
  {
    id:"retatrutide-15", name:"Retatrutide", label:["RETATRUTIDE","15MG"], strength:"15mg vial",
  ...
  {
    id:"nad-500", name:"NAD+", label:["NAD+","500MG"], strength:"500mg vial",
  ...
  {
    id:"mots-c", name:"MOTS-c", label:["MOTS-C","10MG"], strength:"10mg vial",
  ...
  {
    id:"epithalon", name:"Epithalon", label:["EPITHALON","10MG"], strength:"10mg vial",
  ...
  {
    id:"tesamorelin", name:"Tesamorelin", label:["TESAMORELIN","5MG"], strength:"5mg vial",
  ...
  {
    id:"bac-water", name:"Bacteriostatic Water", label:["BAC WATER","10ML"], strength:"10ml vial",
