...
(function(){
 ...
 <div class="coa-badge">✓ &nbsp;Verified · ${lot.status}</div>
 ...
 <p style="font-size:.78rem;color:var(--muted);margin:1.2rem 0 0">Certificate issued by an independent ISO/IEC 17025-accredited laboratory. Full PDF available on request.</p>
</div>`;
